...
export const initialPairs: VideoPair[] = [
  {
    ...
    assignedVA: "Sarah M.", stage: "in_progress", dueDate: "2026-03-01", driveLink: "https://drive.google.com/drive/folders/example1", notes: "", videoAUploaded: true, videoBUploaded: false, qaChecklist: { ...defaultQA },
  },
  {
    ...
    assignedVA: "James K.", stage: "in_progress", dueDate: "2026-03-01", driveLink: "https://drive.google.com/drive/folders/example2", notes: "", videoAUploaded: false, videoBUploaded: false, qaChecklist: { ...defaultQA },
  },
  {
    ...
    assignedVA: "Priya R.", stage: "internal_review", dueDate: "2026-02-28", driveLink: "https://drive.google.com/drive/folders/example3", notes: "Camera shifted slightly, may need reshoot", videoAUploaded: true, videoBUploaded: true, qaChecklist: { cameraPosition: false, lighting: true, oneChange: true, duration: true, resolution: true, naming: true },
  },
  {
    ...
    assignedVA: "Alex T.", stage: "complete", dueDate: "2026-02-27", driveLink: "https://drive.google.com/drive/folders/example4", notes: "Approved ✓", videoAUploaded: true, videoBUploaded: true, qaChecklist: { cameraPosition: true, lighting: true, oneChange: true, duration: true, resolution: true, naming: true },
  },
  {
    ...
    assignedVA: "Sarah M.", stage: "complete", dueDate: "2026-02-27", driveLink: "https://drive.google.com/drive/folders/example5", notes: "Perfect take", videoAUploaded: true, videoBUploaded: true, qaChecklist: { cameraPosition: true, lighting: true, oneChange: true, duration: true, resolution: true, naming: true },
  },
  {
  ...
  },
  {
    ...
    assignedVA: "James K.", stage: "internal_review", dueDate: "2026-02-28", driveLink: "https://drive.google.com/drive/folders/example8", notes: "", videoAUploaded: true, videoBUploaded: true, qaChecklist: { cameraPosition: true, lighting: true, oneChange: true, duration: true, resolution: true, naming: false },
  },
  {
  ...
  },
  {
    ...
    assignedVA: "Priya R.", stage: "in_progress", dueDate: "2026-03-03", driveLink: "https://drive.google.com/drive/folders/example10", notes: "", videoAUploaded: false, videoBUploaded: false, qaChecklist: { ...defaultQA },
  },
  {
    ...
    assignedVA: "Alex T.", stage: "complete", dueDate: "2026-02-26", driveLink: "https://drive.google.com/drive/folders/example11", notes: "Great work!", videoAUploaded: true, videoBUploaded: true, qaChecklist: { cameraPosition: true, lighting: true, oneChange: true, duration: true, resolution: true, naming: true },
  },
  {
